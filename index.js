        ...
        printer
            ...
            .tableCustom(
                [
                  ...
                  { text:format(parseISO(data.created_at), 'hh:mm aaa'), align:"RIGHT", width:0.5},
                ],
              )
            .tableCustom(
                [
                  { text:"Address: Chaltlang", align:"LEFT", width:0.5},
                  { text: format(parseISO(data.created_at), 'dd-MM-Y'), align:"RIGHT", width:0.5},
                ],
              )
            ...
            .tableCustom(
                [
                  ...
                  { text:"Terminal #1", align:"RIGHT", width:0.5},
                ],
              );
           ...
           printer.tableCustom(
            ...
            printer.tableCustom(
                [
                    ...
                    { text: "Rs. "+(data.total_with_gst - data.total_without_gst).toFixed(2), align:"RIGHT", width:0.5},
                ],
            );
            printer.tableCustom(
                [
